/* Builds the foreground executive's situation/prompt/tool catalogue; it does
 * not start a second agent loop. Load only relevant schemas to leave room for
 * the current request. Loading a tool is not executing it or granting motor
 * authority: runTool and the physical controllers enforce those boundaries.
 * Live calibration/evidence outrank old memories and model assumptions. */
