...
\score {
 ...
 % OwlBot: expand both written repeat sections, including alternate endings,
 % for a complete linear MIDI performance. The source notes are unchanged.
 \unfoldRepeats \new PianoStaff
 <<
 \new Staff = "up" {
 \clef treble
...
>>
 ...
 % MIDI-only asset build: no engraving output required by the phone.
